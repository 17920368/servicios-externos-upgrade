            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h1 class="text-center">Editar sector
                        </h1>
                    </div>
                    <div class="card-body">
                        @if (session('success'))
                        ...
                        <form method="POST" action="{{ route('sector.update', $sector->id) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('name', $sector->name, ['class' => 'form-control', 'autofocus', 'autofocus', 'id' => 'rol', 'onkeyup' => 'firstLetterToCapitalize(rol);']) !!}
                                    @error('name')
                            ...
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a class="btn btn-danger" href="{{ route('sector.index') }}"><i class="fa fa-ban"
                                            aria-hidden="true"></i>
                                        Cancelar
                                    </a>
                                </div>
