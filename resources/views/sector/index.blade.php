    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h1 class="text-center h4">Listado sectores.
                        </h1>
                        @if (session('status'))
                        ...
                        <div class="d-flex justify-content-end flex-wrap">
                            <a class="btn btn-primary my-2 ancla" href="{{ route('sector.create') }}" role="button"
                                title="Crear sector">
                                <i class="fa fa-plus"></i></a>
                            <a class=" btn btn-secondary my-2 ancla" href="{{ route('sector.index') }}" role="button"
                                title="Lista completa">
                                <i class="fas fa-list-ul"></i></a>
                            <div class="my-2">
                                <form action="{{ route('sector.index') }}" class="input-group d-flex justify-content-end">
                                            ...
                                            <td class="d-flex justify-content-start"><a title="Editar"
                                                ...
                                                <form action="{{ route('sector.destroy', $sector->id) }}" method="post">
                                                    ...
                                                    <button title="Eliminar" type="submit" class="btn btn-danger ancla"
                                                        onclick="return confirm( '¿Está seguro de eliminar {{ $sector->name }}?') "><i
